...
const API_WRITE_ROUTE_INVALIDATION_SPEC: Record<string, readonly string[]> = {
  ...
  "app/api/p2p/purchase-orders/route.ts": ["invalidateAllServerCaches"],
  "app/api/p2p/purchase-orders/[id]/route.ts": ["invalidateAllServerCaches"],
  "app/api/p2p/goods-receipts/route.ts": ["invalidateAllServerCaches"],
  "app/api/p2p/goods-receipts/[id]/reverse/route.ts": ["invalidateAllServerCaches"],
  ...
  "app/api/netsuite/purchase-orders/[id]/route.ts": ["invalidateAllServerCaches"],
  ...
  "app/api/netsuite/item-receipts/[id]/reverse/route.ts": ["invalidateAllServerCaches"],
  ...
  "app/api/netsuite/inventory/transfers/[id]/complete/route.ts": ["invalidateAllServerCaches"],
  "app/api/netsuite/inventory/transfers/[id]/cancel/route.ts": ["invalidateAllServerCaches"],
  "app/api/netsuite/inventory/transfers/[id]/reverse/route.ts": ["invalidateAllServerCaches"],
  "app/api/netsuite/inventory/issues/route.ts": ["invalidateAllServerCaches"],
  "app/api/netsuite/inventory/issues/[id]/reverse/route.ts": ["invalidateAllServerCaches"],
  "app/api/stock-allocations/transfers/route.ts": ["invalidateAllServerCaches"],
  "app/api/stock-allocations/transfers/[id]/complete/route.ts": ["invalidateAllServerCaches"],
  "app/api/stock-allocations/transfers/[id]/cancel/route.ts": ["invalidateAllServerCaches"],
